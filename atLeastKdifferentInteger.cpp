...
int main(){
    ...
    int result=totalNumberOfSubArrys-count;
    cout<<"The total number of subarrays are "<<totalNumberOfSubArrys<<endl;
    cout<<"The total number of subarrys with atmost k different elements are "<<count<<endl;
    cout<<"The total number of subarrys with least k different elements are "<<result<<endl;
}